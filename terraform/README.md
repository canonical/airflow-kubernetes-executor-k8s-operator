# Terraform module for Airflow Kubernetes Executor

This module deploys the Airflow Kubernetes Executor charm using the [Terraform juju provider](https://github.com/juju/terraform-provider-juju/). For provider details, see the [documentation](https://registry.terraform.io/providers/juju/juju/latest/docs).
...
module "airflow-kubernetes-executor-k8s" {
